public class BMI {
	...
	public static void main(String[] args) {
		...
		if (istFrau && alter <= 24 && bmi >= 19 && bmi <= 24) {
			...
			if (istFrau && alter <= 24 && bmi < 19) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter <= 24 && bmi > 24) {
		...
		if (istFrau && alter >= 25 && alter <= 34 && bmi >= 20 && bmi <= 25) {
			...
			if (istFrau && alter >= 25 && alter <= 34 && bmi < 20) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter >= 25 && alter <= 34 && bmi > 25) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (!istFrau && alter >= 25 && alter <= 34 && bmi >= 21 && bmi <= 26) {
			...
			if (!istFrau && alter >= 25 && alter <= 34 && bmi < 21) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (!istFrau && alter >= 25 && alter <= 34 && bmi > 26) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (istFrau && alter >= 35 && alter <= 44 && bmi >= 21 && bmi <= 26) {
			...
			if (istFrau && alter >= 35 && alter <= 44 && bmi < 21) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter >= 35 && alter <= 44 && bmi > 26) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (!istFrau && alter >= 35 && alter <= 44 && bmi >= 22 && bmi <= 27) {
			...
			if (!istFrau && alter >= 35 && alter <= 44 && bmi < 22) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (!istFrau && alter >= 35 && alter <= 44 && bmi > 27) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (istFrau && alter >= 45 && alter <= 54 && bmi >= 22 && bmi <= 27) {
			...
			if (istFrau && alter >= 45 && alter <= 54 && bmi < 22) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter >= 45 && alter <= 54 && bmi > 27) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (!istFrau && alter >= 45 && alter <= 54 && bmi >= 23 && bmi <= 28) {
			...
			if (!istFrau && alter >= 45 && alter <= 54 && bmi < 23) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (!istFrau && alter >= 45 && alter <= 54 && bmi > 28) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (istFrau && alter >= 55 && alter <= 64 && bmi >= 23 && bmi <= 28) {
			...
			if (istFrau && alter >= 55 && alter <= 64 && bmi < 23) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter >= 55 && alter <= 64 && bmi > 28) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (!istFrau && alter >= 55 && alter <= 64 && bmi >= 24 && bmi <= 29) {
			...
			if (!istFrau && alter >= 55 && alter <= 64 && bmi < 24) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (!istFrau && alter >= 55 && alter <= 64 && bmi > 29) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (istFrau && alter > 64 && bmi >= 24 && bmi <= 29) {
			...
			if (istFrau && alter > 64 && bmi < 24) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (istFrau && alter > 64 && bmi > 29) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
		...
		if (!istFrau && alter > 64 && bmi >= 25 && bmi <= 30) {
			...
			if (!istFrau && alter > 64 && bmi < 25) {
				System.out.println("BMI: " + bmi + " !!UNTERGEWICHT!!");
			} else {
				if (!istFrau && alter > 64 && bmi > 30) {
					System.out.println("BMI: " + bmi + " !!DIÄT!!");
				}
			}
		}
